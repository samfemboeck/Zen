...
{
    // The Batcher is faster than the default XNA implementation since Sprites are not being sorted in the Draw Call here
    // implemented by Prime31 (Nez Framework) and based on the FNA SpriteBatch implementation by Ethan Lee: https://github.com/FNA-XNA/FNA
    using System;
    ...
    public class Batcher : GraphicsResource
    {
        ...
        {
            System.Diagnostics.Debug.Assert(graphicsDevice != null, "Batcher was instantiated without graphicsDevice");
        ...
        public void Begin()
        {
            Begin(BlendState.AlphaBlend, Renderer.DefaultSamplerState, DepthStencilState.None,
        ...
        {
            Begin(blendState, Renderer.DefaultSamplerState, DepthStencilState.None, RasterizerState.CullCounterClockwise,
        ...
        {
            System.Diagnostics.Debug.Assert(!_beginCalled, "Begin has been called before calling End after the last call to Begin. Begin cannot be called again until End has been successfully called.");
            _beginCalled = true;

            _blendState = blendState ?? BlendState.AlphaBlend;
            _samplerState = samplerState ?? Renderer.DefaultSamplerState;
        ...
        public void End()
        {
            System.Diagnostics.Debug.Assert(_beginCalled,
